...
*/
define("Utils", ["require", "exports", "underscore", "String.format", "jQuery", "./Exceptions", "Backbone", "Backbone.Model"], function (require, exports, _, String_format_1, jQuery, Exceptions_1, Backbone, BackboneModel) {
    "use strict";
    ...
    function getTranslatedMessage(errorCode, errorMessage, parameters) {
        try {
            switch (errorCode) {
                case Exceptions_1.ITEM_NO_LONGER_AVAILABLE: {
