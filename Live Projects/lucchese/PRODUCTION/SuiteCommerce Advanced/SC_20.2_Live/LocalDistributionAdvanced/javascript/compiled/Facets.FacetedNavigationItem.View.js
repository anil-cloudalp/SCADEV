...
*/
define("Facets.FacetedNavigationItem.View", ["require", "exports", "underscore", "facets_faceted_navigation_item.tpl", "Utils", "jQuery", "Configuration", "Backbone.View", "Backbone", "ColorUtils", "Bootstrap.Slider"], function (require, exports, _, facets_faceted_navigation_item_tpl, Utils, jQuery, Configuration_1, BackboneView, Backbone, ColorUtils) {
    "use strict";
    return BackboneView.extend({
        ...
        events: {
            ...
            'click .facets-faceted-navigation-item-facet-option': 'makeChecked'
        },
        makeChecked: function (e) {
            var $target = this.$(e.currentTarget);
            var $checkbox = $target.find('.facets-faceted-navigation-item-facet-multi');
            ...
            if (facet_config.behavior !== 'range') {
                _.each(original_values, function (value) {
                    if (value.url !== '') {
                        ...
                        if (self.model.get('id') == "custitem_appf_color_code") {
                            var colObj = ColorUtils.getColorInfo(value.label, '');
                            value.color = _.has(colObj, 'hexcode') ? colObj['hexcode'] : '';
                            value.displayName = _.has(colObj, 'label') ? colObj['label'] : '';
                            value.is_color_tile = true;
                        }
