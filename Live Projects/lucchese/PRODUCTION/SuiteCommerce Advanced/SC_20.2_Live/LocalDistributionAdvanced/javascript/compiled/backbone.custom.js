...
(function (factory) {
    ...
    _.extend(History.prototype, Events, {
        ...
        atRoot: function () {
            ...
            return path === this.root && (/fragment/.test(this.location.search) || !this.getSearch());
        },
        ...
        navigate: function (fragment, options) {
            ...
            if (this.fragment === decodedFragment && !options.trigger)
                return;
...
//# sourceMappingURL=backbone.custom.js.map
