...
*/
define("NavigationHelper", ["require", "exports", "underscore", "Utils", "jQuery", "Session", "PluginContainer"], function (require, exports, _, Utils, jQuery, Session, PluginContainer) {
    "use strict";
        ...
        mountToApp: function (application) {
            ...
            _.extend(Layout, {
                ...
                generateNavigationContext: function (e) {
                    ...
                    var target_touchpoint = (touchpoints ? touchpoints[target_data.touchpoint] : '') || '';
                    var hashtag = target_data.hashtag;
                    var target_href = $target.attr('href');
                    var clean_hashtag = hashtag && hashtag.replace('#', '');
