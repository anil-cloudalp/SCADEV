...
*/
define("Item.Model", ["require", "exports", "underscore", "Utils", "Configuration", "Profile.Model", "UrlHelper", "Backbone.CachedModel", "Session", "Item.KeyMapping", "Item.Option.Collection"], function (require, exports, _, Utils, Configuration_1, Profile_Model_1, UrlHelper_1, BackboneCachedModel, Session, ItemKeyMapping, ItemOptionCollection) {
    "use strict";
    ...
    var ItemModel = BackboneCachedModel.extend({
        ...
        initialize: function initialize() {
            ...
            this.searchApiMasterOptions = Configuration_1.Configuration.get('searchApiMasterOptions.itemDetails', {});
        ...
        getKeyMapping: function getKeyMapping() {
            if (!this._keyMapping) {
                this._keyMapping = _.defaults(Configuration_1.Configuration.itemKeyMapping || {}, ItemKeyMapping.getKeyMapping(Configuration_1.Configuration));
            }
        ...
        getBetterPrice: function getBetterPrice(quantity) {
            ...
            if (hasPriceSchedule) {
                ...
                var isMatrix = this.get('matrixchilditems_detail');
                if (isMatrix) {
                    return null;
                }
                else {
