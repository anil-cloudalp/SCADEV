...
*/
define("SC.Checkout.Starter", ["require", "exports", "Utils", "jQuery", "SC.Checkout", "Environment", "Backbone", "SC.Checkout.Starter.Dependencies", "SC.Extensions"], function (require, exports, Utils, jQuery, SC_Checkout_1, Environment_1, Backbone, entryPointModule, extensionsPromise) {
    "use strict";
    ...
    jQuery(function () {
        extensionsPromise.then(function () {
            ...
            var entryPointModules = entryPointModule.concat(entryPointExtensionsModules);
