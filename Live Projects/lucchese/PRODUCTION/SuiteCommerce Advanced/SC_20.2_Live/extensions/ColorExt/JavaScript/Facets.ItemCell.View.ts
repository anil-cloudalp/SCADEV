...
export = BackboneView.extend({
    ...
    getContext: function() {
		...
		var colorOpt = this.model.getOption('custcol2');
		var values = colorOpt && colorOpt.get('values');
		var firstOpt = _.isArray(values) && values[1];
		var optionUrl = _.has(firstOpt,'url')? firstOpt['url'] : '';
        ...
        return {
            ...
            // @property {String} url
            url: optionUrl || this.model.get('_url'),
            // @property {String} sku
