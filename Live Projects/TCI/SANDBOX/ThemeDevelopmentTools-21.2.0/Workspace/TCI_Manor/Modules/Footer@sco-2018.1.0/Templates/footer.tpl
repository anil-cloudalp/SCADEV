			...
			<div class="footer-social">
		        <div class="footer-content-social">
		            ...
		            {{#each extraFooterView.socialMediaLinks}}
		                <li><a {{objectToAtrributes item}} title={{text}} data-hashtag="{{datahashtag}}" data-touchpoint="{{datatouchpoint}}" data-target="{{datatarget}}" target="_blank">{{#if icon}}<i class="footer-content-social-icon icon-{{icon}}"></i>{{else}}{{text}}{{/if}}</a></li>
		            {{/each}}
		            </ul>
		        </div>
			</div>
