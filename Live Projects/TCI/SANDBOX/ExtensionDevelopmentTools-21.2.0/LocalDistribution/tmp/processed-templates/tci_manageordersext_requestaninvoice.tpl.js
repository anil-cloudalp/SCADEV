define('tci_manageordersext_requestaninvoice.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"container\">\n	<div class=\"cms-pages-side-menu-content\">\n		<div class=\"find-invoice\">\n			<h1>"
    + alias4(((helper = (helper = compilerNameLookup(helpers,"findInvoiceTitle") || (depth0 != null ? compilerNameLookup(depth0,"findInvoiceTitle") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"findInvoiceTitle","hash":{},"data":data,"loc":{"start":{"line":4,"column":7},"end":{"line":4,"column":27}}}) : helper)))
    + "</h1>\n			"
    + ((stack1 = ((helper = (helper = compilerNameLookup(helpers,"findInvoiceDescription") || (depth0 != null ? compilerNameLookup(depth0,"findInvoiceDescription") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"findInvoiceDescription","hash":{},"data":data,"loc":{"start":{"line":5,"column":3},"end":{"line":5,"column":31}}}) : helper))) != null ? stack1 : "")
    ...
    + alias4((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"PO Number or TCI Order Number (for credit card payment):",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":12,"column":6},"end":{"line":12,"column":78}}}))
    + " \n					</label>\n					<div class=\"find-invoice-form-container\" data-validation=\"control\">\n						<input type=\"text\" id=\"order\" name=\"order\">\n					</div>\n					\n					<label class=\"find-invoice-label\" for=\"zip\">\n						"
    + alias4((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Billing Zip Code: ",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":19,"column":6},"end":{"line":19,"column":40}}}))
    + " \n					</label>\n					<div class=\"find-invoice-form-container\" data-validation=\"control\">\n						<input type=\"text\" id=\"zip\" name=\"zip\">\n					</div>\n				</div>\n				<button type=\"submit\" class=\"find-invoice-form-submit\">\n					"
    + alias4((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Search",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":26,"column":5},"end":{"line":26,"column":27}}}))
    + "\n				</button>\n			</form>\n		</div>\n"
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"showTrackInfo") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":30,"column":2},"end":{"line":45,"column":9}}})) != null ? stack1 : "")
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"showNotAvaliable") : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":46,"column":2},"end":{"line":53,"column":9}}})) != null ? stack1 : "")
    + "	</div>\n	<div class=\"cms-pages-side-menu-menu\">\n		<div class=\"cms-pages-side-menu\" data-view=\"SideNavigation\"></div>\n	</div>\n</div>\n\n<!--\n  Available helpers:\n  "
    + alias4((compilerNameLookup(helpers,"getExtensionAssetsPath")||(depth0 && compilerNameLookup(depth0,"getExtensionAssetsPath"))||alias2).call(alias1,"img/image.jpg",{"name":"getExtensionAssetsPath","hash":{},"data":data,"loc":{"start":{"line":62,"column":2},"end":{"line":62,"column":45}}}))
    ...
    + alias4((compilerNameLookup(helpers,"getThemeAssetsPath")||(depth0 && compilerNameLookup(depth0,"getThemeAssetsPath"))||alias2).call(alias1,(depth0 != null ? compilerNameLookup(depth0,"context_var") : depth0),"img/image.jpg",{"name":"getThemeAssetsPath","hash":{},"data":data,"loc":{"start":{"line":66,"column":2},"end":{"line":66,"column":53}}}))
    + " - reference assets in the active theme\n  \n  "
    + alias4((compilerNameLookup(helpers,"getThemeAssetsPathWithDefault")||(depth0 && compilerNameLookup(depth0,"getThemeAssetsPathWithDefault"))||alias2).call(alias1,(depth0 != null ? compilerNameLookup(depth0,"context_var") : depth0),"img/theme-image.jpg",{"name":"getThemeAssetsPathWithDefault","hash":{},"data":data,"loc":{"start":{"line":68,"column":2},"end":{"line":68,"column":70}}}))
