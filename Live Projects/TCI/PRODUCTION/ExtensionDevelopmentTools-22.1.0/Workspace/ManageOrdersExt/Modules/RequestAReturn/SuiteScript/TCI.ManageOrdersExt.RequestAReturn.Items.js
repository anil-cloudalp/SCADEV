		...
		returnRequest: function returnRequest (options) {
			...
			try {
				...
				for (var l = 0; l < itemsToReturn.length; l += 1) {
					...
					html += '\t<li>Item Description: ' + line.description + '<br /> Item Number: ' + line.itemno + '<br /> Item Rate: ' + line.rate + '<br /> <b>Item Quantity: ' + line.quantity + '</b><br /> Item Amount: ' + line.amount + '</li>\n';
				}
				html += '</ol><br />\n';
