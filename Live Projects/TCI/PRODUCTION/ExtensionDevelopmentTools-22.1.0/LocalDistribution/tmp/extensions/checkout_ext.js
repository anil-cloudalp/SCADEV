...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["TCI.CheckoutCustomizationsExtension.CheckoutCustomizationsModule.View","TCI.CheckoutCustomizationsExtension.CheckoutCustomizationsModule.Model","TCI.CheckoutCustomizationsExtension.CheckoutCustomizationsModule.SS2Model","TCI.CheckoutCustomizationsExtension.OrderWizard.Module.PayingWithStep.View","TCI.CheckoutCustomizationsExtension.SchoolDistrictLookup.View","TCI.CheckoutCustomizationsExtension.SchoolDistrictLookup.Model","TCI.CheckoutCustomizationsExtension.OrderWizardModuleCartSummaryExt","TCI.CheckoutCustomizationsExtension.OrderWizardModulePaymentMethodPurchaseNumberExt","TCI.CheckoutCustomizationsExtension.OrderWizardModuleShipmethodExt","TCI.CheckoutCustomizationsExtension.AddressEditViewExt","TCI.CheckoutCustomizationsExtension.UploadFile.View","TCI.CheckoutCustomizationsExtension.AddressEditFieldsViewExt","OrderWizard.Module.SubscriptionEmail.View","Extension.OrderWizard.Module.Confirmation","OrderWizard.Module.SchoolClosureDeliveryDate.View","TCI.ManageOrdersExt.ManageOrdersExt.HeaderLink.View","Acme.printquote.PrintQuote.View","Acme.printquote.PrintQuote.Model","Acme.printquote.PrintQuote.SS2Model","Acme.printquote.PrintQuoteModel.View"];
try{
...
try{
	...
	SC.addExtensionModule('TCI.ManageOrdersExt.ManageOrdersExt.Header');
}
catch(error)
{
	console.error(error);
