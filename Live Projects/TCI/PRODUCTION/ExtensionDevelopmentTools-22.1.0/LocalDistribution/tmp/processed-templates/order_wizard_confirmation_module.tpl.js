define('order_wizard_confirmation_module.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"order-wizard-confirmation-module alert fade in\">\n	<h2 class=\"order-wizard-confirmation-module-title\">"
    ...
    + "	<div class=\"order-wizard-confirmation-module-nextsteps-content\">\n         "
    + ((stack1 = ((helper = (helper = compilerNameLookup(helpers,"confirmationText") || (depth0 != null ? compilerNameLookup(depth0,"confirmationText") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"confirmationText","hash":{},"data":data,"loc":{"start":{"line":17,"column":9},"end":{"line":17,"column":31}}}) : helper))) != null ? stack1 : "")
    + "\n    </div>\n	<a class=\"order-wizard-confirmation-module-continue\" href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"continueURL") || (depth0 != null ? compilerNameLookup(depth0,"continueURL") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"continueURL","hash":{},"data":data,"loc":{"start":{"line":19,"column":60},"end":{"line":19,"column":75}}}) : helper)))
    + "\" "
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"touchPoint") : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":19,"column":77},"end":{"line":19,"column":124}}})) != null ? stack1 : "")
    + " data-hashtag=\"#/\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Continue shopping",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":19,"column":143},"end":{"line":19,"column":176}}}))
    + "</a>\n		<!-- DOWNLOAD AS PDF -->\n	<a href=\""
...
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/TCI/TCI_Manor/1.0.0/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/TCI/TCI_Manor/1.0.0/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'order_wizard_confirmation_module'; return template;});