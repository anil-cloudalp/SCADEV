<section class="facets-facet-browse">
	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-facets {{#if employee}} employee {{/if}}"   data-action="pushable" data-id="product-search-facets">
				...
				<div data-view="Facets.FacetedNavigation"  data-exclude-facets="commercecategoryname"></div>
			...
			<div class="facets-facet-browse-results">
				...
				{{#if isCategory}}
					...
					{{!-- <div data-view="Facets.Browse.CategoryHeading"></div> --}}
						...
						<div data-view="Facets.CategoryCells" class="horizontal"></div>
					</div>
				{{/if}}
