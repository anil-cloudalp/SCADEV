	...
	<div class="list-header-view-accordion" data-action="accordion-header">
		...
		<div class="list-header-view-accordion-body {{initiallyCollapsed}}" data-type="accordion-body"
			...
			<div class="list-header-view-accordion-body-header {{classes}}">
				...
				<div class="custom-Staxs-filters">
					{{#if ShowItemNumberOrName}}
					<span class="custom-Staxs-filters-input">
						<input class="list-header-view-accordion-body-input custom-input-css filter_by_ItemName"
							placeholder="Item Name/Number" value="{{SelectedItem}}" />
					</span>
					{{/if}}
					{{#if StaxsLotNumber}}
					<span class="custom-Staxs-filters-input">

						<input class="list-header-view-accordion-body-input custom-input-css filter_by_Staxs_lot_number"
							placeholder="Staxs Lot Number" value="{{selectedStaxs_lot_filter}}" />
					</span>
					{{/if}}

					{{#if SalesOrder}}
					<span class="custom-Staxs-filters-input">
						<input class="list-header-view-accordion-body-input custom-input-css filter_by_SalesOrder"
							placeholder="SalesOrder" value="{{selectedSalesOrder}}" />
					</span>
					{{/if}}
					{{#if PackingNote}}
					<span class="custom-Staxs-filters-input">
						<input class="list-header-view-accordion-body-input custom-input-css filter_by_packing_note"
							placeholder="Packing Note" value="{{selectedPackingNote}}" />
					</span>
					{{/if}}
					{{#if ExternalLotNum}}
					<span class="custom-Staxs-filters-input">
						<input class="list-header-view-accordion-body-input custom-input-css filter_by_Staxs_ext_number"
							placeholder="External Lot Number" value="{{selectedStaxs_ext_filter}}" />
					</span>
					{{/if}}
				</div>
				...
				<label class="list-header-view-filters">
					<select name="filter" class="list-header-view-accordion-body-select" data-action="filter">
						{{#each filters}}
						<option value="{{itemValue}}" class="{{cssClassName}}" data-permissions="{{permission}}"
