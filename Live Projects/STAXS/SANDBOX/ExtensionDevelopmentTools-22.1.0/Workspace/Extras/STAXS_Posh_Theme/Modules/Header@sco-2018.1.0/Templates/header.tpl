...
<div class="header-main-wrapper custom-header-styles">
	...
	<nav class="header-main-nav">
		<div class="header-content">
			...
			<div class="header-right-menu">
				...
				<div class="header-menu-profile-logout">
					<a class="header-menu-logout" href="#" data-touchpoint="logout" title="Log Out">
						Log Out
					</a>
				</div>
				{{/if}}
...
<div class="header-logo-nav-container">
	...
	<div class="header-horzintal-line"></div>
</div>
