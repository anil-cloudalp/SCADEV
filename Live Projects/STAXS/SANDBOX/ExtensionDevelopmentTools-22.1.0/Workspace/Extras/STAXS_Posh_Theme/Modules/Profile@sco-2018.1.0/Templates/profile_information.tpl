			...
			<fieldset>
				...
				<div class="profile-information-row">
					<label class="profile-information-label">{{translate 'Email'}}</label>
						<p class="profile-information-input-email" id="email">{{email}}
						 {{!-- | <a class="profile-information-change-email-address" data-action="change-email">{{translate 'Change Address'}}</a></p> --}}
				</div>
