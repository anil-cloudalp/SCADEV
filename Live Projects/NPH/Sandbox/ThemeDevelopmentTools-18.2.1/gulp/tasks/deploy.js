...
if(nconf.get('extensionMode'))
{
	...
	*/
	...
	gulp.task('extension:deploy' , _isSkipCompilation ? [] : deploy_task_helper.getCompilationTasks(), startDeploy);
}
else
{
	...
	*/
	...
	var deploy_task_helper = require('../extension-mechanism/deploy/deploy-task-helper')
	gulp.task('theme:deploy', _isSkipCompilation ? [] : deploy_task_helper.getCompilationTasks(), startDeploy);
}
