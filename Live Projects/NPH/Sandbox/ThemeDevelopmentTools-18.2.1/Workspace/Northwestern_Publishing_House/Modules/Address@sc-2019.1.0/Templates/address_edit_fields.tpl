<div class="address-edit-fields">
	...
	<div class="address-edit-fields-group{{#unless isZipOptional}} zip_required{{/unless}}" data-input="zip"  data-validation="control-group">
		<label class="address-edit-fields-group-label" for="{{manage}}zip">
			{{translate 'Zip Code'}} <span class="address-edit-fields-input-required zip_code_star">*</span>
		</label>
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
