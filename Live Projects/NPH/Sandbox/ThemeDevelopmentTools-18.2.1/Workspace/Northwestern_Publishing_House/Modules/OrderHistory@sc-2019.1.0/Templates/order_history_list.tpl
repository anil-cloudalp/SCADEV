...
<section class="order-history-list">
	...
	<div data-view="ListHeader" {{#unless downitems}}class="remove_border_list"{{/unless}} {{#if openIsActive}}style="display:none;"{{/if}}></div>
	{{#unless downitems}}<p class="order-history-list-note">Click on the Purchase No. to see detailed order and tracking information.</p>{{/unless}}
