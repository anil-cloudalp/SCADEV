		...
		<form class="contact_info">
			<fieldset>
				...
				{{#if isperson}}
					{{#with extraFields}}
						<div class="profile-information-row">
							<label class="profile-information-label">{{translate 'Individual Type'}}</label>
								<p class="profile-information-individual-type" id="individual-type">{{indiType}}</p>
						</div>
					{{/with}}
				{{/if}}
				{{#with extraFields}}
					{{#if isPaidForOrg}}
						<div class="profile-information-row">
							<label class="profile-information-label">{{translate 'Organization Name'}}</label>
								<p class="profile-information-value">{{company}}</p>
						</div>
						<div class="profile-information-row">
							<label class="profile-information-label">{{translate 'Organization Type'}}</label>
								<p class="profile-information-value">{{category}}</p>
						</div>
					{{/if}}
				{{/with}}
