...
*/
define("OrderWizard.Module.NonShippableItems", ["require", "exports", "underscore", "order_wizard_non_shippable_items_module.tpl", "Utils", "Wizard.StepModule", "Transaction.Line.Views.Cell.Navigable.View", "Backbone.CollectionView"], function (require, exports, _, order_wizard_non_shippable_items_module_tpl, Utils, Wizard_StepModule_1, Transaction_Line_Views_Cell_Navigable_View_1, BackboneCollectionView) {
    "use strict";
    return Wizard_StepModule_1.WizardStepModule.extend({
        ...
        getLinesNotShippable: function () {
            var lines = _.filter(this.wizard.model.getNonShippableLines(), function (line) {
