...
*/
define("SC.MyAccount.Starter", ["require", "exports", "Utils", "jQuery", "SC.MyAccount", "Environment", "Backbone", "SC.MyAccount.Starter.Dependencies", "SC.Extensions"], function (require, exports, Utils, jQuery, SC_MyAccount_1, Environment_1, Backbone, entryPointModules, extensionsPromise) {
    "use strict";
    var MyAccountStarter = /** @class */ (function () {
        function MyAccountStarter() {
            this.myAccount = SC_MyAccount_1.SCMyAccount.getInstance();
            var self = this;
            jQuery(function () {
                extensionsPromise.then(function () {
                    ...
                    return self.init(entryPointModules.concat(entryPointExtensionsModules));
                });
            });
        }
