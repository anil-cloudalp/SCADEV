...
define("ProductDetails.ImprintOption.View", ["require", "exports", "underscore", "product_details_imprint_option.tpl", "Backbone.View"], function (require, exports, _, product_details_imprint_option_tpl, BackboneView) {
    "use strict";
    var CustomView = BackboneView.extend({
        ...
        imprintInputs: function (e) {
            ...
            if (radiobtn) {
                var x = _.findWhere(this.results, { 'otherChargeItem': radiobtn });
                //console.log(x);
                ...
                if (x.options) {
                    ...
                    _.each(this.locArr, function (value) {
        ...
        getContext: function () {
            ...
            _.each(imprintOptionArr, function (opt) {
                if (opt.id == '1')
                    nameLabel = opt.name;
                if (opt.id == '2')
                    dateLabel = opt.name;
            ...
            if (imprintItem) {
                if (imprintItem.indexOf('|') != -1) {
                    ...
                    var x = _.findWhere(this.results, { 'otherChargeItem': imprintItemId });
...
//# sourceMappingURL=ProductDetails.ImprintOption.View.js.map
