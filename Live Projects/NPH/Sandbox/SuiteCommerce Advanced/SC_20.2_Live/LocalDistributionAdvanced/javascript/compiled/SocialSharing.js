...
*/
define("SocialSharing", ["require", "exports", "underscore", "Utils", "jQuery", "Configuration", "PluginContainer", "Facets.Browse.View", "ProductDetails.Full.View"], function (require, exports, _, Utils, jQuery, Configuration_1, PluginContainer, BrowseView, ProductDetailsFullView) {
    "use strict";
    ...
    var SocialSharing = {
        ...
        setMetaTags: function () {
            ...
            var meta_tag_mapping_og = Configuration_1.Configuration.metaTagMappingOg;
            var meta_tag_mapping_twitter_product_card = Configuration_1.Configuration.metaTagMappingTwitterProductCard;
            var meta_tag_mapping_twitter_gallery_card = Configuration_1.Configuration.metaTagMappingTwitterGalleryCard;
            var link_tag_google_plus_authorship = Configuration_1.Configuration.linkTagGooglePlusAuthorship;
