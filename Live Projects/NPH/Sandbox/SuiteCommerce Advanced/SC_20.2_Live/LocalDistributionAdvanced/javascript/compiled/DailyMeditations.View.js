...
define("DailyMeditations.View", ["require", "exports", "underscore", "daily_meditations.tpl", "Utils", "Backbone", "Backbone.View"], function (require, exports, _, daily_meditations_tpl, Utils, Backbone, BackboneView) {
    "use strict";
    var CustomView = BackboneView.extend({
        ...
        showCalendar: function (month, year) {
            ...
            var self = this;
            this.$('#calendar-dates-row').ready(setTimeout(function () {
...
//# sourceMappingURL=DailyMeditations.View.js.map
