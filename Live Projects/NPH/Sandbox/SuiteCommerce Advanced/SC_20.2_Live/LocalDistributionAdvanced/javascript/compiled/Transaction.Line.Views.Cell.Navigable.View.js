            ...
            if (_.has(this, 'attributes')) {
                if (_.has(this.attributes, 'data-root-component-id')) {
                    if (_.propertyOf(this.attributes)('data-root-component-id') == "Wizard.View") {
                        _.each(line.get('options').models, function (opt) {
