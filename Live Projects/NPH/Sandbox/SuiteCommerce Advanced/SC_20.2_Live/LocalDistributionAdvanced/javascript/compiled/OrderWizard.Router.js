            ...
            return this.orderWizardModel
                ...
                if (last_order_id && !_this.model.get('confirmation').get('internalid')) {
                    if (_this.profileModel.get('isGuest') !== 'T') {
                        ...
                        content =
                            Utils.translate('If you want to review your last order you can go to <a href="#" data-touchpoint="$(0)" data-hashtag="#/ordershistory/view/salesorder/$(1)">Your Account</a>. ', 'customercenter', last_order_id) +
