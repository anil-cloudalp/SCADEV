    ...
    var OrderWizardStep = WizardStep.extend({
        ...
        submit: function submit() {
            ...
            return order_wizard
                ...
                .fail(function (jqXhr) {
                var moduleErrors = jQuery('.global-views-message-error:first');
                var error_container = (moduleErrors.length > 0) ? moduleErrors : jQuery('.order-wizard-paymentmethod-selector-module');
