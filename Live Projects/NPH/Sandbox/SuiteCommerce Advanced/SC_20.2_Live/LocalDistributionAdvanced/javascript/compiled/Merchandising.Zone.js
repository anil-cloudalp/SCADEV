...
*/
define(["require", "exports", "underscore", "Utils", "jQuery", "./Merchandising.Item.Collection", "./Merchandising.Rule", "./Merchandising.Context", "./Merchandising.View", "LiveOrder.Model"], function (require, exports, _, Utils, jQuery, MerchandisingItemCollection, MerchandisingRule, MerchandisingContext, MerchandisingView, LiveOrderModel) {
    "use strict";
    ...
    var MerchandisingZone = function MerchandisingZone(element, options) {
        ...
        var layout = application && application.getLayout && application.getLayout();
        if (!element || !layout) {
            return;
        }
    ...
    _.extend(MerchandisingZone.prototype, {
        ...
        getApiParams: function () {
            ...
            var sorting = this.parseApiSortingOptions();
            if (sorting.length) {
        ...
        getLimit: function () {
            ...
            var limit = model.get('show');
            var exclude = model.get('exclude');
            if (exclude.length) {
        ...
        appendItems: function () {
            ...
            if (items.length) {
                if (this.model.get('template')) {
                    ...
                    var amd_optimize_trick_for_require = Utils.requireModules;
...
//# sourceMappingURL=Merchandising.Zone.js.map
