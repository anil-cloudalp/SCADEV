...
*/
define("Item.KeyMapping", ["require", "exports", "underscore", "Utils", "UrlHelper"], function (require, exports, _, Utils) {
    "use strict";
    var ItemKeyMapping = {
        getKeyMapping: function (configuration) {
            /*
            ...
            return {
                ...
                _thumbnail: function (item) {
                    ...
                    if (item_images_detail.thumbnail) {
                        if (_.isArray(item_images_detail.thumbnail.urls) &&
                ...
                _attributesRating: function (item) {
                    return ((item.get('custitem_ns_pr_attributes_rating') &&
                ...
                _ratingsCountsByRate: function (item) {
                    return ((item.get('custitem_ns_pr_rating_by_rate') &&
                ...
                _quantityavailableforstorepickup_detail: function (item) {
                    return ((item.get('quantityavailableforstorepickup_detail') &&
...
//# sourceMappingURL=Item.KeyMapping.js.map
