    ...
    return BackboneView.extend({
        ...
        getContext: function () {
            ...
            _.each(option_items, function (option_item) {
                var url1 = translator.cloneForOptions({ order: option_item.id, page: 1 }).getUrl();
                var processed_option_item = {
                    configOptionUrl: (translator.facets[0] && translator.facets[0].config.id == "musiciansresource") ? url1.replace("musiciansresource/", "musiciansresource") : url1,
