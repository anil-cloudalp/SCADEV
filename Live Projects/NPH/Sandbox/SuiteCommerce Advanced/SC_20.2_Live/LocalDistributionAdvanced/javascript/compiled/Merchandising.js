...
*/
define(["require", "exports", "underscore", "./Merchandising.Item.Collection", "./Merchandising.Rule", "./Merchandising.jQueryPlugin"], function (require, exports, _, MerchandisingItemCollection, Rule) {
    "use strict";
    return {
        ...
        mountToApp: function (application) {
            ...
            var searchApiMasterOptions = application.getConfig().searchApiMasterOptions || {};
