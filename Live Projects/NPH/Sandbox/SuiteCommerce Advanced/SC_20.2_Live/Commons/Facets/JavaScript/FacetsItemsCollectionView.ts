...
> {
	...
	private readonly isspecialCategory:boolean;
	private readonly previouslyPurchased: any;
    ...
    public constructor(options: FacetsItemsCollectionViewOptions) {
		...
		this.isspecialCategory = options.isspecialCategory;
		this.previouslyPurchased = options.previouslyPurchased;
    }
    ...
    protected getCellViewInstance<TCellViewContext extends object, TCellViewEvent extends object>(
        ...
        return new FacetsItemCellView({
			...
			previouslyPurchased: this.previouslyPurchased
        });
    }
