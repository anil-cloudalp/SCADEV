    ...
    submit: function submit() {
        ...
        return order_wizard
            ...
            .fail(function(jqXhr) {
				...
				const moduleErrors = jQuery('.global-views-message-error:first');
				
                const error_container = (moduleErrors.length > 0 )? moduleErrors: jQuery('.order-wizard-paymentmethod-selector-module');
