...
define('MusicianResourceGetitems.Model', [
    ...
    return SCModel.extend({
        ...
        getoptions: function(){
            ...
            var fieldsarray = ['customlist_appf_instrument_type','customlist_appf_rites','customlist_hymn_section','customlist_sunday_year','customlist_sunday_sunday','customlist_meter','customlist_packages','customlist_scripture_reference_book'];
