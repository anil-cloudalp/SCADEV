...
import '../../../Advanced/SCA/JavaScript/Configuration';
...
export = WizardStepModule.extend({
    ...
    childViews: {
        'Items.Collection': function() {
			...
			var lines = _.filter(this.lines, function (line:any) {  return line.get('item').get('custitem_appf_is_imprint_item') != true; });
    ...
    getContext: function() {
		...
		var lines2 = _.filter(this.lines, function (line:any) {  return line.get('item').get('custitem_appf_is_imprint_item') != true; })
		,	item_count = LiveOrderModel.countItems(lines2);
