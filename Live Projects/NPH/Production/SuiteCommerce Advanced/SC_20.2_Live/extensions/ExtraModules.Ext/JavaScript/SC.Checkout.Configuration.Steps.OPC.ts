...
import { CheckoutStepGroup } from '../../../Advanced/CheckoutApplication/JavaScript/CheckoutStepsFactory';
...
import CheckoutCustomFields = require('./CheckoutCustomFields');
        ...
        steps: [
            {
                ...
                modules: [
                    ...
                    [OrderWizardModuleTitle, { title: Utils.translate('Payment Method') }],
                    [
                        OrderWizardModulePaymentMethodSelector,
                        { record_type: 'salesorder', prevent_default: true, hide_title: true}
                    ],
                    [OrderWizardModulePaymentMethodGiftCertificates],
                    OrderWizardModulePaymentMethodPurchaseNumber,
					
					[OrderWizardModuleTitle, {title:  Utils.translate('Billing Address'), exclude_on_skip_step: true}],
                    [
