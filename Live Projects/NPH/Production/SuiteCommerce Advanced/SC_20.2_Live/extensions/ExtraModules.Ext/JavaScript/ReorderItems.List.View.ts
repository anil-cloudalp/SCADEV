...
import { ReorderItemsActionsQuantityView } from '../../../Advanced/ReorderItems/JavaScript/ReorderItems.Actions.Quantity.View';
...
import ReorderItemsActionsAddToCartView = require('../../../Advanced/ReorderItems/JavaScript/ReorderItems.Actions.AddToCart.View');
            ...
            const view = new BackboneCollectionView({
                collection: this.collection.filter(function(line) {
                    return (
						...
						(line.get('item').get('custitem_appf_is_imprint_item') != true)
                    );
                }),
                viewsPerRow: 1,
