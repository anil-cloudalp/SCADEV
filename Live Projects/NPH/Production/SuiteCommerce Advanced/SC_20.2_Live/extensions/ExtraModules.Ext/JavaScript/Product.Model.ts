...
import '../../../Commons/PluginContainer/JavaScript/PluginContainer';
...
import ProductOptionCollection = require('../../../Commons/Product/JavaScript/Product.Option.Collection');
...
const ProductModel: any = Backbone.Model.extend(
    {
		...
		subscriptionOptions: function()
		{
			...
			var showGiftOption = this.getItem().get('custitem_appf_is_gift') || false
			,	showRenewalNotice = this.getItem().get('custitem_appf_send_renewal_notice') || false;
