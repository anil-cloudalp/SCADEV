...
*/
define("OrderWizard.Module.CartItems.Ship", ["require", "exports", "underscore", "order_wizard_cartitems_module_ship.tpl", "Utils", "Wizard.StepModule", "Backbone.CollectionView", "Address.Details.View", "Transaction.Line.Views.Cell.Navigable.View", "LiveOrder.Model", "Configuration"], function (require, exports, _, order_wizard_cartitems_module_ship_tpl, Utils, Wizard_StepModule_1, BackboneCollectionView, Address_Details_View_1, Transaction_Line_Views_Cell_Navigable_View_1, LiveOrderModel) {
    "use strict";
    return Wizard_StepModule_1.WizardStepModule.extend({
        ...
        childViews: {
            'Items.Collection': function () {
                var lines = _.filter(this.lines, function (line) { return line.get('item').get('custitem_appf_is_imprint_item') != true; });
        ...
        getContext: function () {
            ...
            var lines2 = _.filter(this.lines, function (line) { return line.get('item').get('custitem_appf_is_imprint_item') != true; }), item_count = LiveOrderModel.countItems(lines2);
