...
*/
define("Profile.Information.View", ["require", "exports", "underscore", "profile_information.tpl", "Utils", "jQuery", "Configuration", "GlobalViews.Message.View", "Profile.Model", "Profile.ChangeEmailAddress.Model", "Profile.ChangeEmailAddress.View", "Backbone.View", "Backbone.FormView"], function (require, exports, _, profile_information_tpl, Utils, jQuery, Configuration_1, GlobalViews_Message_View_1, Profile_Model_1, ProfileChangeEmailModel, ProfileChangeEmailView, BackboneView, BackboneFormView) {
    "use strict";
    ...
    var ProfileInformationView = BackboneView.extend({
        ...
        beforeShowContent: function () {
            var service_url = Utils.getAbsoluteUrl('services/CustomModules.Service.ss?profile=T');
            var self = this;
            var promise = jQuery.get(service_url).then(function (res) {
                if (res && _.has(res, 'results'))
                    self.extraFields = res.results;
            });
            return promise;
        },
