...
*/
define("RequestQuoteWizard", ["require", "exports", "underscore", "jQuery", "Profile.Model", "RequestQuoteWizard.Router", "RequestQuoteWizard.View", "RequestQuoteWizard.Configuration", "Quote.Model", "ProductList.Model", "ProductList.Item.Model", "Transaction.Line.Model", "Backbone"], function (require, exports, _, jQuery, Profile_Model_1, RequestQuoteWizardRouter, RequestQuoteWizardView, RequestQuoteWizardConfiguration, Quote_Model_1, ProductListModel, ProductListItemModel, TransactionLineModel, Backbone) {
    "use strict";
    return {
        // @method mountToApp
        ...
        mountToApp: function (application) {
            ...
            var requestQuoteWizard = application.getConfig().requestQuoteWizard;
            var config = {
                steps: requestQuoteWizard.steps || [],
                model: new Quote_Model_1.QuoteModel(),
        ...
        changeQuantity: function (line) {
            ...
            var product_list_item = {
                description: '',
                options: line.get('options').toJSON(),
            ...
            var product_list_item_model = new ProductListItemModel(product_list_item);
...
//# sourceMappingURL=RequestQuoteWizard.js.map
