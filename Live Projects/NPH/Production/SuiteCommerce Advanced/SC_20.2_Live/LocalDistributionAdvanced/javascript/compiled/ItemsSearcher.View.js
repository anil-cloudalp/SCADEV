...
*/
define("ItemsSearcher.View", ["require", "exports", "underscore", "Utils", "itemssearcher.tpl", "jQuery", "ItemsSearcher.Utils", "ItemsSearcher.Collection", "ItemsSearcher.Item.View", "PluginContainer", "Backbone.View"], function (require, exports, _, Utils, itemssearcher_tpl, jQuery, ItemsSearcherUtils, ItemsSearcherCollection, ItemsSearcherItemView, PluginContainer, BackboneView) {
    "use strict";
    ...
    var ItemsSearcherView = BackboneView.extend({
        ...
        defaultOptions: {
            ...
            placeholderLabel: Utils.translate('Search for...'),
        ...
        loadSuggestionItemsSource: function loadSuggestionItemsSource(query, callback, callbackAsync) {
            ...
            self.collection
                ...
                data: {
                    ...
                    offset: 0,
                    custitem_appf_is_imprint_item: false
                },
