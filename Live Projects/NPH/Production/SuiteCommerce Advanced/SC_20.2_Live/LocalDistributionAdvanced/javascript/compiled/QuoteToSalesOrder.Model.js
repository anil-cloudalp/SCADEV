...
*/
define("QuoteToSalesOrder.Model", ["require", "exports", "Utils", "jQuery", "Configuration", "Transaction.Model", "OrderHistory.Model", "Tracker", "Backbone"], function (require, exports, Utils, jQuery, Configuration_1, TransactionModel, OrderHistoryModel, Tracker, Backbone) {
    "use strict";
    return TransactionModel.extend({
        ...
        // @return {String}
        urlRoot: function () {
            var url = Utils.getAbsoluteUrl('services/QuoteToSalesOrder.Service.ss?quoteid=') +
                this.get('quoteid') +
                '&salesorderid=' +
                this.get('salesorderid');
            if (Utils.parseUrlOptions(Backbone.history.location.search).externalPayment) {
...
//# sourceMappingURL=QuoteToSalesOrder.Model.js.map
