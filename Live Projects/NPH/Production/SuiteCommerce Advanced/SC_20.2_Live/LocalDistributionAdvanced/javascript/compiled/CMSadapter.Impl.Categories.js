...
*/
define("CMSadapter.Impl.Categories", ["require", "exports", "underscore", "Utils", "jQuery", "Categories.Model", "Categories.Collection", "Configuration", "AjaxRequestsKiller", "Facets.Model", "Facets.Helper", "Facets.Browse.View", "Facets.Router", "Categories", "Backbone"], function (require, exports, _, Utils, jQuery, Categories_Model_1, Categories_Collection_1, Configuration_1, AjaxRequestsKiller_1, FacetsModel, FacetsHelper, FacetsBrowseView, FacetsRouter, Categories, Backbone) {
    "use strict";
    /*
    ...
    */
    ...
    AdapterCategories.prototype.getItems = function (filters, functionToCallback) {
        var model = new FacetsModel({
            searchApiMasterOptions: Configuration_1.Configuration.get('searchApiMasterOptions.CmsAdapterSearch')
        });
        model
            .fetch({
