...
*/
define("ProductLine.Common.Url", ["require", "exports", "underscore", "Utils", "Configuration", "UrlHelper", "PluginContainer"], function (require, exports, _, Utils, Configuration_1, UrlHelper_1, PluginContainer) {
    "use strict";
    ...
    var ProductLineCommonUrl = {
        ...
        getQuery: function getQuery(parameters_to_override) {
            var query = '';
            var line_model = this;
            var attributes_to_map_in_url = _.filter(_.keys(line_model.attributes), function (attribute) {
                return !!~_.indexOf(ProductLineCommonUrl.attributesReflectedInURL, attribute);
            });
            var all_parameters = _.map(attributes_to_map_in_url, function (attribute) {
            ...
            _.each(Utils.parseUrlOptions(location.search), function (value, name) {
            ...
            query = _.reduce(params_to_set, function (memo_url, option) {
                return UrlHelper_1.UrlHelper.setUrlParameter(memo_url, option.param, encodeURIComponent(option.value));
            }, query);
            return query;
        },
        ...
        mapURLParametersToOptions: function mapURLParametersToOptions(url_parameters) {
            ...
            this.get('options').each(function (option) {
                if (url_parameters[option.get('urlParameterName')]) {
                    ...
                    var selected_option_value = void 0;
...
//# sourceMappingURL=ProductLine.Common.Url.js.map
