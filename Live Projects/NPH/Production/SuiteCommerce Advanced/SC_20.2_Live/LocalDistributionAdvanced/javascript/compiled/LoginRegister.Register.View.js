...
*/
define("LoginRegister.Register.View", ["require", "exports", "underscore", "login_register_register.tpl", "Loggers", "Utils", "jQuery", "Configuration", "Profile.Model", "Account.Register.Model", "Tracker", "LiveOrder.Model", "Backbone.FormView", "Backbone", "Backbone.View", "GlobalViews.States.View", "GlobalViews.CountriesDropdown.View", "./captcha"], function (require, exports, _, register_tpl, Loggers_1, Utils, jQuery, Configuration_1, Profile_Model_1, AccountRegisterModel, Tracker, LiveOrderModel, BackboneFormView, Backbone, BackboneView, GlobalViewsStatesView, CountriesDropdownView) {
    "use strict";
    ...
    var LoginRegisterRegisterView = BackboneView.extend({
        ...
        childViews: {
            'CountriesDropdown': function () {
                ...
                var selectedCountry = Configuration_1.Configuration.get('siteSettings.defaultshipcountry') || 'US';
            ...
            'StatesView': function () {
                return new GlobalViewsStatesView({
                    ...
                    selectedCountry: Configuration_1.Configuration.get('siteSettings.defaultshipcountry')
                });
            }
        },
        ...
        beforeShowContent: function beforeShowContent() {
            ...
            if (profileModel.get('isLoggedIn') === 'T' && profileModel.get('isGuest') === 'F') {
                ...
                var self = this;
                if (this.isRegister) {
                    var suiteletUrl = Configuration_1.Configuration.get('registerss.url');
