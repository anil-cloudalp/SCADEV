...
*/
define("PaymentWizard.Step", ["require", "exports", "payment_wizard_step.tpl", "Utils", "Footer.View", "Wizard.Step", "Header.View"], function (require, exports, payment_wizard_step_tpl, Utils, Footer_View_1, WizardStep, HeaderView) {
    "use strict";
    ...
    var PaymentWizardStep = WizardStep.extend({
        ...
        footerView: Footer_View_1.FooterView,
        render: function () {
