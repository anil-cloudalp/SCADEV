...
*/
define("Header.Menu.View", ["require", "exports", "header_menu.tpl", "jQuery", "Configuration", "Profile.Model", "Header.Profile.View", "Header.Menu.MyAccount.View", "GlobalViews.HostSelector.View", "GlobalViews.CurrencySelector.View", "Backbone.View", "SessionStorageHandler", "./jQuery.sidebarMenu"], function (require, exports, header_menu, jQuery, Configuration_1, Profile_Model_1, HeaderProfileView, HeaderMenuMyAccountView, GlobalViewsHostSelectorView, GlobalViewsCurrencySelectorView, BackboneView, SessionStorageHandler) {
    "use strict";
    return BackboneView.extend({
        ...
        getContext: function () {
            var currentPageURL = window.location.hash.toLocaleLowerCase();
