...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-overview">
		...
		<a class="header-menu-myaccount-signout-link" {{#if isMusicianResourcePage}}  data-action="Music-Home" data-navigation="ignore-click" {{else}}href="#" data-touchpoint="logout"{{/if}} name="signout">
	...
	<li class="header-menu-myaccount-item-level2 header-menu-myaccount-level2-orders" data-permissions="{{purchasesPermissions}}" data-permissions-operator="OR">
		...
		<ul class="header-menu-myaccount-level3 header-menu-myaccount-level3-orders">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#downloadable-items" name="downloadable-items">
					{{translate 'Downloadable Items'}}
				</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#musician-resource-products" name="musician-resource-products">
					{{translate "Musician's Resource Products"}}
				</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#my-subscriptions" name="my-subscriptions">
	...
	{{#if isProductListsEnabled}}
		<li class="header-menu-myaccount-item-level2">
			<a class="header-menu-myaccount-anchor-level2" name="wishlist"><!-- href="#" data-touchpoint="customercenter" data-hashtag="#wishlist"-->
				{{translate 'Wishlist'}}
			</a>
