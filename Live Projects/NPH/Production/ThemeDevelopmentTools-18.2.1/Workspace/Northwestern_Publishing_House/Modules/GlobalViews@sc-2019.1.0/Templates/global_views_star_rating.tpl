		...
		{{#if showRatingCount}}
			<span class="global-views-star-rating-review-total">
				...
				{{#if ratingCountGreaterThan0}}
					...
					{{/if}}
					<span> | </span>
					<span class="global-views-star-rating-no-review-link"><a href="{{itemUrl}}/newReview">Add Your Review</a></span>
				{{else}}
					...
					<span class="global-views-star-rating-no-review-link"><a href="{{itemUrl}}/newReview">Be the first to review this product</a></span>
				{{/if}}
			</span>
		{{/if}}
	</div>
