...
<div class="cart-summary">
									...
									{{/if}}
										...
										<div data-validation="control-group">
											<label for="zip" class="cart-summary-label">
												...
												{{/if}}
												{{#if isZipCodeRequire}} <span class="input-required">*</span>{{/if}}
											</label>
	...
	{{#if showActions}}
		<div class="cart-summary-button-container">
			<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="#" data-touchpoint="checkout" data-hashtag="#{{#if showLoginPage}}login-register{{/if}}">
