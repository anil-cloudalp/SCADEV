		...
		<div class="list-header-view-accordion" data-action="accordion-header">
			...
			<div class="list-header-view-accordion-body {{initiallyCollapsed}}" data-type="accordion-body" {{{accordionStyle}}}>
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{#if rangeFilter}}
						<div class="list-header-view-datepicker-from">
							...
							<div class="list-header-view-datepicker-container-input">
								...
								<i class="list-header-view-accordion-body-calendar-icon" id="from-icon"></i>
						...
						<div class="list-header-view-datepicker-to">
							...
							<div class="list-header-view-datepicker-container-input">
								...
								<i class="list-header-view-accordion-body-calendar-icon" id="to-icon"></i>
								<a class="list-header-view-accordion-body-clear" data-action="clear-value">
									<i class="list-header-view-accordion-body-clear-icon"></i>
								</a>
							</div>
					...
					{{/if}}
					<div class="list-header-view-datepicker-to" id="searchformusic" style="display:none">
						<div class="list-header-view-datepicker-container-input id="newsearch">
							<input class="list-header-view-accordion-body-input" type="text" data-type="searchso" placeholder="Search..." id="searchfield" value="{{searchvalue}}" />
							{{#if isValueExists}}
								<a class="list-header-view-accordion-body-clear" id="clearsearch" data-action="clear-search">
									<i class="list-header-view-accordion-body-clear-icon"  id = "clear-icon"></i>
								</a>
							{{/if}}	
						</div>
					</div>
