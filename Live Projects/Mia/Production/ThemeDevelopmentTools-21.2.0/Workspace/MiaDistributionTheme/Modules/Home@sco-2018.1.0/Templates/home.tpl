 <div class="home">
           ...
           <div class="form-in-home-page">
                <div class=" row form-tab-home">
                   <div class="col-sm-12 form-content">
                        <div class="get-in-touch-text-in-home-page">Get In Contact</div>
                            ...
                            <form method="POST" class="form-home-page">
                                ...
                                <div class="submit-button-content">
                                    <a class="submit-home-button" data-action="submitcontent" type="submit">Submit</a>
                                </div>
                                ...
                                <div class="see-vendors-button-content">
                                    <a class="see-vendors-home-button">See Vendors</a>
                                </div>
                            </form>
       ...
       <div class="home-cms-content-3">
	    ...
	    <div class="home-cms-content-4">
            <div class="view-all-post" data-cms-area="home_cms_main_content-bottom-content-view-all-post" data-cms-area-filters="path"></div>
       </div>
    </div>
