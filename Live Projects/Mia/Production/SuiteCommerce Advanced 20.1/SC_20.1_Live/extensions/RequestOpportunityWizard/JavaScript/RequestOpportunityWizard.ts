...
/// <amd-module name="RequestOpportunityWizard"/>
...
import RequestOpportunityWizardRouter = require('./RequestOpportunityWizard.Router');
import RequestOpportunityWizardView = require('./RequestOpportunityWizard.View');
import RequestOpportunityWizardConfiguration = require('./RequestOpportunityWizard.Configuration');
...
import OpportunityListView = require('./Opportunity.List.View');
import OpportunityDetailsView = require('./Opportunity.Details.View');

// @class RequestOpportunityWizard @extend ApplicationModule
export = {
    // @method mountToApp
    // @param {ApplicationSkeleton} application
    // @return {RequestOpportunityWizard.Router} Returns a new instance of the RequestOpportunityWizard.Router router
    mountToApp: function(application) {
        ...
        pageType.registerPageType({
            ...
            routes: ['opportunities', 'opportunities?:options'],
            view: OpportunityListView,
            defaultTemplate: {
                name: 'quote_list.tpl',
                displayName: 'Opportunity default'
            }
        });
		pageType.registerPageType({
            name: 'OpportunityDetail',
            routes: ['opportunities/:id'],
            view: OpportunityDetailsView,
            defaultTemplate: {
                name: 'quote_details.tpl',
                displayName: 'Opportunity details default'
            }
        });
		
        application.Configuration.requestOpportunityWizard = RequestOpportunityWizardConfiguration;

        this.application = application;

        const config = {
            steps: application.getConfig('requestOpportunityWizard.steps', []),
        ...
        const requestRouter = new RequestOpportunityWizardRouter(application, config);

        RequestOpportunityWizardView.wizard = requestRouter;
