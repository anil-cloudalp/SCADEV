...
/// <amd-module name="CashSale.Collection"/>

import * as _ from 'underscore';
import * as Utils from '../../../Commons/Utilities/JavaScript/Utils';

import Model = require('./CashSale.Model');
import Backbone = require('../../../Commons/Utilities/JavaScript/backbone.custom');

// @class CashSale.Collection @extends Backbone.Collection
const CashSaleCollection: any = Backbone.Collection.extend({
    // @property {CashSale.Model} model
    model: Model,
    // @property {Boolean} cacheSupport enable or disable the support for cache (Backbone.CachedModel)
    cacheSupport: false,
    // @property {String} url
    url: 'services/CashSale.Service.ss',
    // @method initialize
    ...
    applyRangeFilter: function() {
        ...
        this.reset(
            this.original.filter(function(cashsale) {
                const when = new Date(cashsale.get('tranDateInMilliseconds')).getTime();
