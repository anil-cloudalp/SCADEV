...
import PhotoSwipe = require('../../../Commons/Utilities/JavaScript/photoswipe');
import PhotoSwipeUI_Default = require('../../../Commons/Utilities/JavaScript/photoswipe-ui');
...
const ProductDetailsImageGalleryView: any = BackboneView.extend({
	...
	initPhotoSwipe: function(){
		...
		var items = _.map(this.images,function(img:any){
			var obj = {
				src: img.url,
				w:'2500',
				h:'2500'
