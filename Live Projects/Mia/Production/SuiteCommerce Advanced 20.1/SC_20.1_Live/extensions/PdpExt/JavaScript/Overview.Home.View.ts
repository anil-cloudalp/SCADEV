...
import OverviewBannerView = require('../../../Advanced/Overview/JavaScript/Overview.Banner.View');
import OverviewProfileView = require('../../../Advanced/Overview/JavaScript/Overview.Profile.View');
import OverviewPaymentView = require('../../../Advanced/Overview/JavaScript/Overview.Payment.View');
import OverviewShippingView = require('../../../Advanced/Overview/JavaScript/Overview.Shipping.View');
...
import ReportsView = require('../../../extensions/MyAccExt/JavaScript/Reports.View');
import ReportsModulesModel = require('../../../extensions/MyAccExt/JavaScript/ReportsModules.Model');
...
const OverviewHomeView: any = BackboneView.extend({
    ...
    beforeShowContent: function beforeShowContent() {
        ...
        this.collection
            ...
            .always(function() {
                    ...
                    var salesOrderModel = new ReportsModulesModel();

                    var salesOrderPromise: any = salesOrderModel.fetch();

                    salesOrderPromise.then(function(data: any) {
    ...
    getContext: function() {
        ...
        var marketingBanners = this.model.get('marketingBanners'); 
        if(!_.isEmpty(marketingBanners))
        {
            if(marketingBanners.main_banner_item !== ''){
                marketingBanners.has_main_banner_item = true;
            }
            else{
                  marketingBanners.has_main_banner_item = false;
            }
        }
