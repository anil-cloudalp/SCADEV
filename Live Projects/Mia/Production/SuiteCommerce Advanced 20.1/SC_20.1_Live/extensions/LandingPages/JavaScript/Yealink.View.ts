...
/// <amd-module name="Yealink.View"/>
/// <reference path="../../../Commons/Utilities/JavaScript/UnderscoreExtended.d.ts"/>
import * as _ from 'underscore';
import * as yealink_tpl from 'yealink.tpl';
...
const YealinkView: any = BackboneView.extend({
    template: yealink_tpl,

    title: Utils.translate('Yealink IP Desktop Audio & Video Conferencing| Mia Distribution'),
