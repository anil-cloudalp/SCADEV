...
/// <amd-module name="Engenius.View"/>
/// <reference path="../../../Commons/Utilities/JavaScript/UnderscoreExtended.d.ts"/>
import * as _ from 'underscore';
import * as engenius_tpl from 'engenius.tpl';
...
const EngeniusView: any = BackboneView.extend({
    template: engenius_tpl,

    title: Utils.translate('Engenius DECT Phones | Mia Distribution'),
