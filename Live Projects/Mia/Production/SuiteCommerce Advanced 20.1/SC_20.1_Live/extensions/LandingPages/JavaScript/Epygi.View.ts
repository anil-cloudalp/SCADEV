...
/// <amd-module name="Epygi.View"/>
/// <reference path="../../../Commons/Utilities/JavaScript/UnderscoreExtended.d.ts"/>
import * as _ from 'underscore';
import * as epygi_tpl from 'epygi.tpl';
...
const EpygiView: any = BackboneView.extend({
    template: epygi_tpl,

    title: Utils.translate('Epygi Voip Gateway Hardware | Mia Distribution'),
