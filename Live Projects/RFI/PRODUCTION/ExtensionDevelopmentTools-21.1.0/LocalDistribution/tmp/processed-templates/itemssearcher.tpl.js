define('itemssearcher.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<input class=\"custom-search-input\" \r\ndata-type=\"search-input\"\r\nplaceholder=\"Enter keyword, item, model #\"\r\ntype=\"search\"\r\nautocomplete=\"off\"\r\n"
    ...
    + "\r\nmaxlength=\""
    + container.escapeExpression(((helper = (helper = compilerNameLookup(helpers,"maxLength") || (depth0 != null ? compilerNameLookup(depth0,"maxLength") : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"maxLength","hash":{},"data":data}) : helper)))
    + "\"/>\r\n\r\n\r\n\r\n\r\n";
