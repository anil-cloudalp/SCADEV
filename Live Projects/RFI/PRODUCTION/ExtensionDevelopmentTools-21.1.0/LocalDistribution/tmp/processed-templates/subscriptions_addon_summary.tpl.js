define('subscriptions_addon_summary.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"subscriptions-addon-summary-container\">\r\n\r\n"
    + ((stack1 = compilerNameLookup(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? compilerNameLookup(depth0,"hasItemPrice") : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "\r\n    </div>\r\n";
  ...
  return "            <h3 class=\"subscriptions-addon-summary-title\">Summary</h3>\r\n            <div class=\"subscriptions-addon-summary-subtotal-wrapper\">\r\n                <h4 class=\"subscriptions-addon-summary-subtotal\">"
    ...
    + alias3(((helper = (helper = compilerNameLookup(helpers,"frequency") || (depth0 != null ? compilerNameLookup(depth0,"frequency") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"frequency","hash":{},"data":data}) : helper)))
    + "</small></span>\r\n                </p>\r\n            </div>\r\n\r\n";
