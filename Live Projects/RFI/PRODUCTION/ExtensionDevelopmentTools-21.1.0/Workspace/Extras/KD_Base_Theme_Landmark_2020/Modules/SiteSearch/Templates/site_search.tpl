    ...
    <div class="site-search-content">
        <form class="site-search-content-form" method="GET" action="/search" data-action="search">
            <div class="site-search-content-input">
				<div class="site-search-content-view" data-view="ItemsSeacher"></div>
            ...
            <button class="site-search-button-submit" type="submit"><i class="header-menu-search-icon"></i></button>
        </form>
    </div>
</div>
