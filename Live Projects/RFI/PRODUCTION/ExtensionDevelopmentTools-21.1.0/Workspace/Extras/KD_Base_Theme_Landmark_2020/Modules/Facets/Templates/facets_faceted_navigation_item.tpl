{{#if showFacet}}
	<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}}-wrapper" data-type="collapse" title="{{facetDisplayName}}">
