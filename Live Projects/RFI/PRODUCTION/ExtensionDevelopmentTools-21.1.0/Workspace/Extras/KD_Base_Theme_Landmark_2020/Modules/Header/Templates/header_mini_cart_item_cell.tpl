		...
		<div class="header-mini-cart-item-cell-details">
			<ul>
				<li class="header-mini-cart-item-cell-product-title">
					<a {{{linkAttributes}}} class="header-mini-cart-item-cell-title-navigable" style="color: black !important; font-size: 14px !important; padding: 0 !important;">{{line.item._name}}</a>
				</li>
		    ...
		    {{else}}
		    	<li style="color: black;">
					{{translate '<a data-touchpoint="login" data-hashtag="login-register" origin-hash="" href="#" style="color: rgb(7, 54, 116) !important;     font-size: 12px !important; font-weight: 600!important; padding-right: 0; padding-left: 0;">Login</a> to see price'}}
				</li>
		    {{/if}}
