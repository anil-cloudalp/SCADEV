		...
		<div class="product-details-qv-content-title-secondline">
			<div class="qv-container">
				...
				<div class="product-line-mpn-container">
					<span class="product-line-mpn-label">{{translate 'MPN: '}} </span>
					<span class="Product-line-mpn-value">{{model.item.mpn}}</span>
				</div>
				{{/if}}
		...
		<div class="product-details-quickview-main">
			{{#if isItemProperlyConfigured}}
				<form id="product-details-quickview-form" data-action="submit-form" method="POST">
					...
					<p class="qv-minimumQty"><strong>(*) Minimum Quantity: {{ model.item.minimumquantity }}</strong></p>
					{{/if}}
