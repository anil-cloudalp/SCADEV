<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}}" data-item-type="{{itemType}}">
	...
	<td class="transaction-line-views-cell-navigable-amount" name="item-amount">
			{{#if inStockMessage}}
		<p class="transaction-line-views-cell-navigable-item-instock-label">
	
		<span class="transaction-line-views-cell-navigable-item-amount-label  " style='color: #4a7f35;'>{{inStockMessage}}</span>
