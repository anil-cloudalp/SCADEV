	...
	<div class="facets-item-cell-list-right">
		...
		<div class="facets-item-cell-list-right-section-one">
			...
			<div class="item-details-sku-container">
				SKU: <span class="item-details-sku">{{sku}}</span>
			</div>
			...
			{{!--<!-- Extension Facets Item Info - Store Description -->--}}
			{{#if extensionFacetsItemFields.storeDescription}}
				<div class="brief-description-content">{{{extensionFacetsItemFields.storeDescription}}}</div>
			{{/if}}
