...
extensions['MIA.MiaRewardsExtension.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/MIA/MiaRewardsExtension/1.0.0/' + asset;
}
...
// -----------------------
// @module Case
define("MIA.MiaRewardsExtension.MiaRewardsModule.Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
...
// -----------------------
// @module Case
define("MIA.MiaRewardsExtension.MiaRewardsModule.SS2Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
    ...
    return Backbone.Model.extend({
        ...
        urlRoot: Utils.getAbsoluteUrl(
            getExtensionAssetsPath(
                "Modules/MiaRewardsModule/SuiteScript2/MiaRewardsModule.Service.ss"
            ),
            true
        )
});
...
extensions['MIA.PrincipalRegistration.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/MIA/PrincipalRegistration/1.0.0/' + asset;
}
...
*/
define('jquery.signature', ['jQuery'], function ($) {
	'use strict';
 ...
 */
define('html2Canvas', ['jQuery'], function ($) {
	'use strict';
...
extensions['CloudAlp.SCACASEFORM.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CloudAlp/SCACASEFORM/1.0.0/' + asset;
}
...
define(
	'CloudAlp.SCACASEFORM.SCACASEFORM'
	, [
		'CloudAlp.SCACASEFORM.SCACASEFORM.View'
	]
	, function (
		SCACASEFORMView
	) {
		...
		return {
			mountToApp: function mountToApp(container) {
				...
				// 		return new SCACASEFORMView({ container: container });
				// 	});
				// }
...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["MIA.MiaRewardsExtension.MiaRewardsModule.View","MIA.MiaRewardsExtension.MiaRewardsModule.Model","MIA.MiaRewardsExtension.MiaRewardsModule.SS2Model","MIA.MiaRewardsExtension.SubmitClaim.View","MIA.MiaRewardsExtension.Confirmation.View","MIA.PrincipalRegistration.PrincipalRegistrationModule.View","MIA.PrincipalRegistration.PrincipalRegistrationModule.Model","MIA.PrincipalRegistration.PrincipalRegistrationModule.SS2Model","jquery.signature","html2Canvas","CloudAlp.SCACASEFORM.SCACASEFORM.View","CloudAlp.SCACASEFORM.SCACASEFORM.Model","CloudAlp.SCACASEFORM.SCACASEFORM.SS2Model","CloudAlp.ShippingAndBillingAddress.ShippingAndBillingAddress.View","CloudAlp.ShippingAndBillingAddress.ShippingAndBillingAddress.Model","CloudAlp.ShippingAndBillingAddress.ShippingAndBillingAddress.SS2Model"];
try{
	extensions['MIA.MiaRewardsExtension.1.0.0']();
	SC.addExtensionModule('MIA.MiaRewardsExtension.MiaRewardsModule');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['MIA.PrincipalRegistration.1.0.0']();
	SC.addExtensionModule('MIA.PrincipalRegistration.PrincipalRegistrationModule');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['CloudAlp.SCACASEFORM.1.0.0']();
	SC.addExtensionModule('CloudAlp.SCACASEFORM.SCACASEFORM');
}
catch(error)
{
	console.error(error);
