			...
			<p class="order-wizard-cart-summary-grid-float">
				...
				<span class="order-wizard-cart-summary-subtotal-label">
					{{#if itemCountGreaterThan1}}
						{{translate '<span class="order-wizard-cart-summary-item-quantity-subtotal" data-type="cart-summary-subtotal-count">Subtotal ($(0) items)</span>' itemCount}}
					{{else}}
						{{translate '<span class="order-wizard-cart-summary-item-quantity-subtotal" data-type="cart-summary-subtotal-count">Subtotal ($(0) item)</span>' itemCount}}
					{{/if}}
					<p class="order-wizard-cart-summary-subtotal-legend">{{translate 'Subtotal does not include shipping or tax'}}
					</p>
				</span>
			</p>
		</div>
