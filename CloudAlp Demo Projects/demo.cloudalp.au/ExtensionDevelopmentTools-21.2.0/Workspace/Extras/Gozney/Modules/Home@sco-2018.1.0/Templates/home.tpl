<div class="home">
								...
								{{/if}}">
									...
									{{#if isAbsoluteUrl}}
										<div class="home-slide-image-container use-image" style="background-image:url('{{image}}');">
											<a {{objectToAtrributes item}} class="home-slide-wrap-link">
												<img src="{{resizeImage image 'homeslider'}}"
													class="home-slide-image {{#if imageMobile}}hide-small{{/if}}">
												{{#if imageMobile}}
													<img src="{{resizeImage imageMobile 'homeslider'}}" class="home-slide-image-mobile" />
												{{/if}}
											</a>
										</div>
									...
									{{/if}}">
										<div class="home-slide-caption {{captionTextAlign}}">
											{{#if title}}
												<h1 class="home-slide-caption-title" style="color:{{captionColor}}">{{{title}}}</h1>
											{{/if}}
											{{#if text}}
												<h2 class="home-slide-caption-text" style="color:{{captionColor}}">{{{text}}}</h2>
											{{/if}}
											{{#if linktext}}
					...
					{{else}}
						...
						{{else}}
							<li>
								<div class="home-slide-main-container">
									<div class="home-slide-image-container"
										style="background-image:url('{{getThemeAssetsPath 'img/carousel-home-1.jpg'}}');">
							...
							<li>
								<div class="home-slide-main-container">
									<div class="home-slide-image-container"
										style="background-image:url('{{getThemeAssetsPath 'img/carousel-home-2.jpg'}}');">
							...
							<li>
								<div class="home-slide-main-container">
									<div class="home-slide-image-container"
										style="background-image:url('{{getThemeAssetsPath 'img/carousel-home-3.jpg'}}');">
				...
				<div class="home-infoblock">
					<a {{objectToAtrributes item}} class="home-infoblock-link">
						<img class="home-infoblock-image"
							src="{{getThemeAssetsPathWithDefault image 'img/banner-bottom-home-1.jpg'}}" alt="{{title}}" />
						{{#if title}}
							<div class="home-infoblock-text">{{title}}</div>
						{{/if}}
					</a>
				</div>
			{{/each}}
	...
	{{#if extraHomeView.hero}}
		<div class="home-hero">
			<div class="home-hero-image" {{#if extraHomeView.hero.image}}
