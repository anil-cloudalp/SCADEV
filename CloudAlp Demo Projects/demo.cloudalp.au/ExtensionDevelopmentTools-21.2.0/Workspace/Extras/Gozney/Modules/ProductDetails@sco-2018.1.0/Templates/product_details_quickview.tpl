...
<div class="product-details-quickview">
	...
	<div class="product-details-quickview-details">
		...
		<a class="product-details-quickview-full-details" data-action="go-to-fullview" data-touchpoint="home"
			data-name="view-full-details" data-hashtag="#{{itemUrl}}" href="{{itemUrl}}">
		...
		<div class="product-details-quickview-main">
			{{#if isItemProperlyConfigured}}
				<form id="product-details-quickview-form" data-action="submit-form" method="POST">
					...
					{{!-- storedescription --}}
					{{#if this.model.item.storedescription}}
						<div class="product-detailsquickview-storedescription-sec">
							<p class="product-detailsquickview-storedescription-text">
								{{{this.model.item.storedescription}}}
							</p>
						</div>
					{{/if}}
					{{!-- storedescription end --}}
						...
						<section class="product-details-quickview-actions">
							...
							{{!-- <div class="product-details-quickview-actions-container">
								<div data-view="ProductDetails.AddToQuote"
									class="product-details-quickview-actions-container-add-to-quote"></div>
							</div> --}}
