...
<div class="product-details-full">
    ...
    <article class="product-details-full-content">
                        ...
                        <form id="product-details-full-form" data-action="submit-form" method="POST">
                            ...
                            {{#if isDownloadsAvailable}}
                                <section class="download-files-section">
                                    <div class="box-menu">
                                        <div class="">
                                            <div class="download-files-description" id="tab-pdf-downloads">
                                                <ol class="download-files-ol">
                                                    {{#if pdfsExtras}}
                                                        {{#each pdfsExtras}}
                                                            <li class="download-files-li ">
                                                                <div class="download-files-link">
                                                                    <a href='{{{url}}}' target="_blank" download="pdf">
                                                                        <button
                                                                            class="button-secondary pdp-downloads">{{name}}</button>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                        {{/each}}
        ...
        <section class="product-details-full-bottom-content">
            ...
            <section class="product-details-full-main-product-information-container" data-view="Product.Information">
            </section>
