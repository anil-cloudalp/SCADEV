<div class="address-edit-fields">
	...
	<div class="address-edit-fields-group" data-input="phone" data-validation="control-group">
		...
		<div class="address-edit-fields-group-form-controls" data-validation="control">
			<input type="tel" class="address-edit-fields-group-input" id="{{manage}}phone" name="phone" value="{{phone}}"
	...
	{{#if isBillingPage}}
		<div class="address-edit-fields-group" data-input="defaultbilling">
			<label class="address-edit-fields-group-input-checkbox">
				<input type="checkbox" class="default-check" id="{{manage}}defaultbilling" value="T" data-unchecked-value="F"
	...
	{{#if isAddressCollectionLength1checkout }}
		<div class="address-edit-fields-group" data-input="defaultbilling">
			<label class="address-edit-fields-group-input-checkbox">
				<input type="checkbox" class="default-check" id="{{manage}}defaultbilling" value="T" data-unchecked-value="F"
					name="defaultbilling" checked>
		...
		<div class="address-edit-fields-group" data-input="defaultshipping">
			<label class="address-edit-fields-group-input-checkbox">
				<input type="checkbox" class="default-check" id="{{manage}}defaultshipping" value="T" data-unchecked-value="F"
	...
	{{#if showDefaultControls}}
		{{#if isAddressCollectionLength1myaccount}}
			<div class="address-edit-fields-group" data-input="defaultshipping">
				<label class="address-edit-fields-group-input-checkbox">
					<input type="checkbox" class="default-check" id="{{manage}}defaultshipping" value="T" data-unchecked-value="F"
