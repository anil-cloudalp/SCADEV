<div class="facets-item-cell-list" itemprop="itemListElement" data-item-id="{{itemId}}"
		...
		<div class="facets-item-cell-list-image-wrapper">
			...
			{{#if itemIsNavigable}}
				<a class="facets-item-cell-list-anchor" href='{{url}}'>
					<img class="facets-item-cell-list-image" src="{{resizeImage thumbnail.url 'thumbnail'}}"
	...
	<div class="facets-item-cell-list-right">
		...
		<div data-view="Store.Description" class="facets-item-cell-list-Store-Description"></div>
		...
		<div data-view="Cart.QuickAddToCart" class="facet-item-cell-list-price"></div>
