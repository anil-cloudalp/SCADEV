					...
					{{!-- {{#if isVisible}}
					 <span class="list-header-view-download">
					    <label class="list-header-view-download-filter">
						 ...
						 <button class="download_btn" data-action="download_btn">Download</button>
					 </span>
					 {{/if}} --}}
					{{!----Custom Changes End----}}
					{{!--- Custom Changes extension----}}
					{{#if isActive}}
					 <span class="list-header-view-download">
					    <label class="list-header-view-download-filter">
						    <select name="checkDownloadInExtension" id="checkDownloadInExtension" class="list-header-view-accordion-body-select" data-action="checkDownloadInExtension">
								<option value="downloadCsvButton">{{translate 'Download Csv'}}</option>	
								<option value="downloadPDFButton">{{translate 'Download PDF'}}</option>	
							</select> 
						</label>
						 <button class="download_btn" data-action="download_file_inExt">Download File</button>
					 </span>
					 {{/if}}
					{{!----Custom Changes End----}}
