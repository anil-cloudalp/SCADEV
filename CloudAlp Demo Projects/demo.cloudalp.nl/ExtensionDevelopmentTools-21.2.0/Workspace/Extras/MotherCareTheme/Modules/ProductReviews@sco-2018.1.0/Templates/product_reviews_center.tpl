			...
			{{#if itemCount}}
				<div class="product-reviews-center-container">
					<div class="product-reviews-center-container-header">
						...
						<div style="display: flex;align-items: center;" class="review-section">
                    ...
                    <section class="product-reviews-center-list">
                        ...
                        {{#if totalRecords}}
						<h2 class="most-recent-reviews-title"> most recent reviews </h2>
                            <div data-view="ProductReviews.Review" class="product-reviews-center-review-container reveal-closed"></div>
							
							<button type="button" class="see-more-reviews-btn" data-toggle="morereviewsbtn"> see more reviews </button>
                        {{else}}
