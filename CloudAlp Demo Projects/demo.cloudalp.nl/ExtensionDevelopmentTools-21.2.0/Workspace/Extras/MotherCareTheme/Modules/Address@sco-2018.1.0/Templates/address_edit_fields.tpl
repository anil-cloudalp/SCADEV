...
<div class="address-edit-fields-group" data-input="isdefalutship">
		<label class="address-edit-fields-group-input-checkbox">
			<input type="checkbox" id="isdefalutship" data-action="isdefalutAddress" value="T"  data-unchecked-value="F" name="custrecorddefalut_ship">
			{{translate 'Use this  Address as default Ship address'}}
		</label>
</div>

<div class="address-edit-fields-group" data-input="isdefalutbill">
		<label class="address-edit-fields-group-input-checkbox">
			<input type="checkbox" id="isdefalutbill" data-action="isdefalutAddress" value="T"  data-unchecked-value="F" name="custrecorddefault_billing">
			{{translate 'Use this  Address as default bill address'}}
		</label>
</div>
