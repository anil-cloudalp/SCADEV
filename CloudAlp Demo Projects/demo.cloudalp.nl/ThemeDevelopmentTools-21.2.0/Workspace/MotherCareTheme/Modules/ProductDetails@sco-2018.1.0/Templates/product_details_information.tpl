				...
				<div role="tabpanel">
					...
					<div class=" product-details-information-tab-content" data-type="information-content" data-action="tab-content">
						{{#each details}}
							...
							<div class="description-titlecaret"><h2  data-target="#{{name}}" class="product-details-information-tab-content-panel-title" data-toggle="collapse">{{name}} <span class="discriptioncaret"><span class="header-menu-settings-carret accordion-carret"></span></span</h2>
							</div>
							<div id="{{name}}" id="product-details-information-tab-content-container-{{@index}}" class="collapse product-details-information-tab-content-container" data-type="information-content-text">{{{content}}}</div>
					</div>
					{{/each}}
				</div>
			</div>
