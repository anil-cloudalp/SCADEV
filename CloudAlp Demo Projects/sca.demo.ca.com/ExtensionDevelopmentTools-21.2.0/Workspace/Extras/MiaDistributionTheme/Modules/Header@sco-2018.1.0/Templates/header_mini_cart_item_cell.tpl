<li class="header-mini-cart-item-cell" data-item-id="{{itemId}}" data-item-type="{{itemType}}">
		...
		<div class="header-mini-cart-item-cell-details">
			...
			{{#if CartSidebar}}
				<div name="remove-mini-cart-item" class="new-customization-cross-bar" data-internalid="{{lineId}}">
					<div class="main-container-of-customization">
						<div class="data-cross">×</div>
					</div>
				</div>
			{{else}}

				<div name="remove-mini-cart-item" class="new-customization-cross-bar" data-internalid="{{lineId}}">×</div>
			{{/if}}
		</div>
