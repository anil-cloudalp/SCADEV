...
<section class="return-authorization-form">
	...
	<form class="return-authorization-form-form">
		...
		<fieldset class="return-authorization-form-comment-fieldset">
			<label class="return-authorization-form-comment-label" for="comment">{{translate 'upload an img <span class="return-authorization-form-comment-label-optional">(optional)</span>'}}</label>
