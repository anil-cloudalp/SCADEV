{{#if showFacet}}
	<div class="facets-faceted-navigation-item-color-facet-group" id="{{htmlId}}" data-type="rendered-facet"
		...
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-color-facet-group-expander" data-toggle="collapse"
					data-target="#{{htmlId}} .facets-faceted-navigation-item-color-facet-group-wrapper" data-type="collapse"
		...
		{{else}}
			<div
				class="facets-faceted-navigation-item-color-facet-group-wrapper {{#if isCollapsed}} collapse {{else}} in{{/if}}">
		{{/if}}
		<div class="facets-faceted-navigation-item-color-facet-group-content">
			<ul class="facets-faceted-navigation-item-color-picker">
				{{#each displayValues}}
					...
					<li>
						<a href="{{link}}" title="{{label}}" data-color="{{label}}"
							class="facets-faceted-navigation-item-color-option {{#if isLightColor}}white-border{{/if}} {{#if isActive}}active{{/if}}">
							{{#if isImageTile}}
			...
			{{#if showExtraValues}}
				<ul class="facets-faceted-navigation-item-color-picker-extra collapse">
					{{#each extraValues}}
						<li>
							<a href="{{link}}" title="{{label}}" data-color="{{label}}"
								class="facets-faceted-navigation-item-color-extra-option {{#if isLightColor}}white-border{{/if}} {{#if isActive}}active{{/if}}">
								{{#if isImageTile}}
									<img src="{{image.src}}" alt="{{label}}" width="{{image.width}}" height="{{image.height}}">
								{{else}}
									<span style="background: {{color}}"></span>
				...
				<div class="facets-faceted-navigation-item-color-optionlist-extra-wrapper">
					<a class="facets-faceted-navigation-item-color-optionlist-extra-button" data-toggle="collapse"
						data-target="#{{htmlId}} .facets-faceted-navigation-item-color-picker-extra" data-action="see-more">
