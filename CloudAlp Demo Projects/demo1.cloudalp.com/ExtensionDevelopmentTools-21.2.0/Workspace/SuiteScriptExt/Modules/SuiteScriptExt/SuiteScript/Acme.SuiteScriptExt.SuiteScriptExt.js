	// @module Case
define('Acme.SuiteScriptExt.SuiteScriptExt', ['SC.Model', 'Application', 'Utils', 'underscore', 'Configuration'], function(
    SCModel,
    Application,
    Utils,
    _,
    ...
    return SCModel.extend({
        ...
        create: function (customerId, data) {
            ...
            newCaseRecord.setFieldValue('custevent9', '10/26/2022');
