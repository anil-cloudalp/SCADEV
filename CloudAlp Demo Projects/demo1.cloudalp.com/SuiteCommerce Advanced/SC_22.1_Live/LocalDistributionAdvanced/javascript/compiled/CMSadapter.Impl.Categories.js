...
*/
define("CMSadapter.Impl.Categories", ["require", "exports", "underscore", "Utils", "jQuery", "Categories.Model", "Categories.Collection", "Configuration", "MasterOptionsHelper", "AjaxRequestsKiller", "Facets.Model", "Facets.Helper", "Facets.Browse.View", "Facets.Router", "Categories", "Backbone"], function (require, exports, _, Utils, jQuery, Categories_Model_1, Categories_Collection_1, Configuration_1, MasterOptionsHelper_1, AjaxRequestsKiller_1, FacetsModel, FacetsHelper, FacetsBrowseView, FacetsRouter, Categories, Backbone) {
    "use strict";
    /*
    ...
    */
    ...
    AdapterCategories.prototype.showCategory = function (categoryData, functionToCallback) {
        ...
        var categoryModel = new Categories_Model_1.CategoriesModel(this._convertToCategory(categoryData));
    ...
    AdapterCategories.prototype.updateCategory = function (data, application, functionToCallback) {
        if (data.saving) {
            var collection = new Categories_Collection_1.CategoriesCollection({
            ...
            collection.fetch().done(function (menu) {
                ...
                if (!data.category.parents.length &&
    ...
    AdapterCategories.prototype.getItems = function (filters, functionToCallback) {
        var model = new FacetsModel({
            searchApiMasterOptions: MasterOptionsHelper_1.MasterOptionsHelper.getSearchAPIMasterOption('CmsAdapterSearch')
        });
        model
            .fetch({
...
//# sourceMappingURL=CMSadapter.Impl.Categories.js.map
